...
class AdminRepository extends ChangeNotifier {
  ...
  void setUserStatus(String id,AdminUserStatus status){final i=_users.indexWhere((u)=>u.id==id);if(i<0)return;_users[i]=_users[i].copyWith(status:status);notifyListeners();}
