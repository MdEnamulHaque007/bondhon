    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(widget.authorName, style: Theme.of(context).textTheme.titleMedium),
            ...
            Row(
              children: [
                DropdownButton<FeedPrivacy>(
                  ...
                  items: [
                    DropdownMenuItem(value: FeedPrivacy.public, child: Text(strings.publicPrivacy)),
                    DropdownMenuItem(value: FeedPrivacy.friends, child: Text(strings.friendsPrivacy)),
                    DropdownMenuItem(value: FeedPrivacy.onlyMe, child: Text(strings.onlyMePrivacy)),
                  ],
                ),
                const Spacer(),
                FilledButton.icon(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(_relativeTime(post.createdAt, strings), style: Theme.of(context).textTheme.bodySmall),
                      ],
                    ),
                  ),
                  Chip(
...
String _privacyLabel(AppLocalizations strings, FeedPrivacy privacy) => switch (privacy) {
